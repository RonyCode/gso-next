...
export const CarSchema = z.object({
  car: z
    .object({
      ...
      local: z.number().min(1, { message: 'id inválido' }),
      type: z.number().min(1, { message: 'id inválido' }),
      condition_car: z.number().min(1, { message: 'id inválido' }),
      status: z.number().min(1, { message: 'id inválido' }),
