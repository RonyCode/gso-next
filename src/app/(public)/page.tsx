    ...
    <>
      <main className="  h-full w-full">
        <header className="h-full w-full">
          <BannerHome1 />
          <div className="flex h-full w-full  items-end justify-evenly bg-background   text-foreground">
            <svg
              width="100%"
              height="50%"
              id="svg"
        ...
        <div
          className="min-h-screen w-full rotate-180 bg-secondary  bg-cover bg-center bg-no-repeat text-foreground brightness-75"
          style={{
